...
export class CustomerService {
 ...
 getByUserId(userId:any):Observable<SingelResponseModel<Customer>>{
   let newPath=this.apiUrl+"userid?Id="+userId
   return this.httpClient.get<SingelResponseModel<Customer>>(newPath);
 }
